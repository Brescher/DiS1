...
namespace DiS_1_Sem
{
    internal class SimulationTaskB : SimulationCore
    {
        ...
        GenCM routeBCM;
        double timeRouteB;
        //ArrayList timesRouteB = new ArrayList();
        //ArrayList probablilitiesTaskB = new ArrayList();
        ...
        //public ArrayList TimesRouteB { get => timesRouteB; set => timesRouteB = value; }
        //public ArrayList ProbablilitiesTaskB { get => probablilitiesTaskB; set => probablilitiesTaskB = value; }
        ...
        {
            //TimesRouteB.Add(timeRouteB);
            if (timeRouteB <= 320)
            {
                hits++;
            }
            probabilityTaskB = hits / RepsDone;
            //probablilitiesTaskB.Add(probabilityTaskB);
        }

        public override void AfterSimulation()
        {
            ProbabilityTaskB = hits / replications;
            //probablilitiesTaskB.Clear();
            //TimesRouteB.Clear();
        }
